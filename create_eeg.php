    ...
    <div class="container-fluid col-md-12" id="EEG-interpretation">
        ...
        <section>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" id="staticEEGID" name="staticEEGID" value="3">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control" id="staticEEGIndications" name="staticEEGIndications" rows="3">34 yo man with a hx of possible convulsions in his youth, then recurring at age 51. Recently with TBI followed by memory problems and staring spells.</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input class="form-control" type="text" id="staticCurrentMeds" name="staticCurrentMeds" value="levetiracetam, baclofen">
                </div>
            </div>
        </section>
